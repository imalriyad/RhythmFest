...
const Contact = () => {
    const contactFormHandler = (e)=>{
     e.preventDefault()
     toast.success('Message Send successfully! We Will reply back you soon')
    }
    return (
        <div className="px-4">
        <div className="w-full max-w-sm mx-auto mt-[5%] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          <htmlForm className="space-y-6">
            ...
            <form onSubmit={contactFormHandler} className="space-y-3">
              ...
              <textarea rows={4} className="textarea w-full textarea-info" placeholder="Leave a Message for us . . ."></textarea>
              <button
                type="submit"
